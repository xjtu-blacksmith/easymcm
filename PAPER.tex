...
\problem{A}  % 请在此处填写题号
\usepackage{mathptmx}  % 这个是 Times 字体，中规中矩 
%\usepackage{mathpazo}  % 这个是 COMAP 官方杂志采用的更好看的 Palatino 字体，如需使用可将上面的 mathptmx 宏包注释掉，改用这个
...
\bibitem{2} \emph{A simple, easy \LaTeX\ template for MCM/ICM: EasyMCM}. (2018) Retrieved December 1, 2019, from\url{https://www.cnblogs.com/xjtu-blacksmith/p/easymcm}
\end{thebibliography}
